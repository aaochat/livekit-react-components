...
function useConnectionState(room) {
  ...
  const observable = React15.useMemo(() => (0, import_components_core5.connectionStateObserver)(r2), [r2]);
...
function useFocusToggle({ trackRef, props }) {
  ...
  const layoutContext = useMaybeLayoutContext();
  const { className } = React17.useMemo(() => (0, import_components_core7.setupFocusToggle)(), []);
  const inFocus = React17.useMemo(() => {
    return (0, import_components_core7.isTrackReferencePinned)(trackReference, layoutContext == null ? void 0 : layoutContext.pin.state);
...
function useIsSpeaking(participant) {
  ...
  const observable = React20.useMemo(() => (0, import_components_core10.createIsSpeakingObserver)(p2), [p2]);
...
function useLocalParticipant(options = {}) {
  ...
  React21.useEffect(() => {
    const listener = (0, import_components_core11.observeParticipantMedia)(room.localParticipant).subscribe(handleUpdate);
    return () => listener.unsubscribe();
  }, [room]);
  return {
    isMicrophoneEnabled,
...
function useParticipantTile({
  ...
  const micTrack = trackReference.participant.getTrackPublication(import_livekit_client4.Track.Source.Microphone);
  const micRef = React27.useMemo(() => {
    return {
      participant: trackReference.participant,
      source: import_livekit_client4.Track.Source.Microphone,
...
function useRemoteParticipants(options = {}) {
  ...
  React28.useEffect(() => {
    const listener = (0, import_components_core17.connectedParticipantsObserver)(room, {
...
function useRoomInfo(options = {}) {
  const room = useEnsureRoom(options.room);
  const infoObserver = React31.useMemo(() => (0, import_components_core18.roomInfoObserver)(room), [room]);
...
function useStartAudio({ room, props }) {
  ...
  const { className, roomAudioPlaybackAllowedObservable, handleStartAudioPlayback } = React32.useMemo(
    () => (0, import_components_core19.setupStartAudio)(),
    []
  );
...
function useStartVideo({ room, props }) {
  ...
  const { className, roomVideoPlaybackAllowedObservable, handleStartVideoPlayback } = React33.useMemo(
    () => (0, import_components_core20.setupStartVideo)(),
    []
  );
...
function useChatToggle({ props }) {
  ...
  const { className } = React35.useMemo(() => (0, import_components_core21.setupChatToggle)(), []);
...
function useTrackMutedIndicator(trackRef) {
  ...
  const { className, mediaMutedObserver } = React36.useMemo(
    () => (0, import_components_core22.setupTrackMutedIndicator)(trackReference),
    [(0, import_components_core22.getTrackReferenceId)(trackReference)]
  );
...
function useTracks(sources = [
  ...
  const sources_ = React38.useMemo(() => {
    return sources.map((s2) => (0, import_components_core24.isSourceWitOptions)(s2) ? s2.source : s2);
...
function usePersistentUserChoices(options = {}) {
  ...
  const [userChoices, setSettings] = React40.useState(
    (0, import_components_core25.loadUserChoices)(options.defaults, (_a2 = options.preventLoad) != null ? _a2 : false)
  );
  ...
  React40.useEffect(() => {
    var _a3;
    (0, import_components_core25.saveUserChoices)(userChoices, (_a3 = options.preventSave) != null ? _a3 : false);
...
function useIsEncrypted(participant) {
  ...
  const observer = React41.useMemo(() => (0, import_components_core26.encryptionStatusObservable)(room, p2), [room, p2]);
  const isEncrypted = useObservableState(
    observer,
    p2 instanceof import_livekit_client6.LocalParticipant ? p2.isE2EEEnabled : p2.isEncrypted
  );
  return isEncrypted;
}
...
var useMultibandTrackVolume = (trackOrTrackReference, options = {}) => {
  var _a2;
  const track = trackOrTrackReference instanceof import_livekit_client7.Track ? trackOrTrackReference : (_a2 = trackOrTrackReference == null ? void 0 : trackOrTrackReference.publication) == null ? void 0 : _a2.track;
  ...
  React42.useEffect(() => {
    ...
    const { analyser, cleanup } = (0, import_livekit_client7.createAudioAnalyser)(track, opts.analyserOptions);
...
// src/components/controls/MediaDeviceSelect.tsx
var MediaDeviceSelect = /* @__PURE__ */ React43.forwardRef(function MediaDeviceSelect2(_a2, ref) {
  var _b = _a2, {
    kind,
    initialSelection,
  ...
  const handleError = React43.useCallback(
    (e2) => {
      if (room) {
        room.emit(import_livekit_client8.RoomEvent.MediaDevicesError, e2);
      }
...
function MediaDeviceMenu(_a2) {
  ...
  const handleActiveDeviceChange = (kind2, deviceId) => {
    import_components_core29.log.debug("handle device change");
    setIsOpen(false);
  ...
  React44.useLayoutEffect(() => {
    if (button.current && tooltip.current && (devices || updateRequired)) {
      (0, import_components_core28.computeMenuPosition)(button.current, tooltip.current).then(({ x: x2, y: y2 }) => {
        if (tooltip.current) {
  ...
  const handleClickOutside = React44.useCallback(
    (event) => {
      ...
      if (isOpen && (0, import_components_core28.wasClickOutside)(tooltip.current, event)) {
        setIsOpen(false);
      }
    },
...
var SvgMicIcon = (props) => /* @__PURE__ */ React51.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "currentColor" }, props), /* @__PURE__ */ React51.createElement(
  "path",
  {
    fillRule: "evenodd",
...
), /* @__PURE__ */ React51.createElement("path", { d: "M5 3a3 3 0 1 1 6 0v5a3 3 0 0 1-6 0z" }));
var MicIcon_default = SvgMicIcon;

// src/assets/icons/QualityExcellentIcon.tsx
var React52 = __toESM(require("react"));
var SvgQualityExcellentIcon = (props) => /* @__PURE__ */ React52.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "currentcolor" }, props), /* @__PURE__ */ React52.createElement("path", { d: "M0 11.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-6a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React52.createElement("path", { d: "M0 11.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-6a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }));
var QualityExcellentIcon_default = SvgQualityExcellentIcon;

// src/assets/icons/QualityGoodIcon.tsx
var React53 = __toESM(require("react"));
var SvgQualityGoodIcon = (props) => /* @__PURE__ */ React53.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "currentcolor" }, props), /* @__PURE__ */ React53.createElement("path", { d: "M0 11.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React53.createElement("path", { d: "M0 11.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React53.createElement("g", { opacity: 0.25 }, /* @__PURE__ */ React53.createElement("path", { d: "M12 .5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React53.createElement("path", { d: "M12 .5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" })));
var QualityGoodIcon_default = SvgQualityGoodIcon;

// src/assets/icons/QualityPoorIcon.tsx
var React54 = __toESM(require("react"));
var SvgQualityPoorIcon = (props) => /* @__PURE__ */ React54.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "currentcolor" }, props), /* @__PURE__ */ React54.createElement("path", { d: "M0 11.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React54.createElement("path", { d: "M0 11.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React54.createElement("g", { opacity: 0.25 }, /* @__PURE__ */ React54.createElement("path", { d: "M6 6.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React54.createElement("path", { d: "M6 6.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-6a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React54.createElement("path", { d: "M12 .5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" })));
var QualityPoorIcon_default = SvgQualityPoorIcon;

// src/assets/icons/QualityUnknownIcon.tsx
var React55 = __toESM(require("react"));
var SvgQualityUnknownIcon = (props) => /* @__PURE__ */ React55.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "currentColor" }, props), /* @__PURE__ */ React55.createElement("g", { opacity: 0.25 }, /* @__PURE__ */ React55.createElement("path", { d: "M0 11.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-6a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" }), /* @__PURE__ */ React55.createElement("path", { d: "M0 11.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5zm6-6a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5z" })));
var QualityUnknownIcon_default = SvgQualityUnknownIcon;

// src/assets/icons/ScreenShareIcon.tsx
var React56 = __toESM(require("react"));
var SvgScreenShareIcon = (props) => /* @__PURE__ */ React56.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 20, height: 16, fill: "none" }, props), /* @__PURE__ */ React56.createElement(
  "path",
  {
    fill: "currentColor",
    fillRule: "evenodd",
...
var SvgScreenShareStopIcon = (props) => /* @__PURE__ */ React57.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 20, height: 16, fill: "none" }, props), /* @__PURE__ */ React57.createElement("g", { fill: "currentColor" }, /* @__PURE__ */ React57.createElement("path", { d: "M7.28 4.22a.75.75 0 0 0-1.06 1.06L8.94 8l-2.72 2.72a.75.75 0 1 0 1.06 1.06L10 9.06l2.72 2.72a.75.75 0 1 0 1.06-1.06L11.06 8l2.72-2.72a.75.75 0 0 0-1.06-1.06L10 6.94z" }), /* @__PURE__ */ React57.createElement(
  "path",
  {
    fillRule: "evenodd",
...
var SvgSpinnerIcon = (props) => /* @__PURE__ */ React58.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none" }, props), /* @__PURE__ */ React58.createElement(
  "path",
  {
    fill: "currentColor",
    fillRule: "evenodd",
...
var SvgUnfocusToggleIcon = (props) => /* @__PURE__ */ React59.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none" }, props), /* @__PURE__ */ React59.createElement("g", { stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5 }, /* @__PURE__ */ React59.createElement("path", { d: "M13.25 7H9m0 0V2.75M9 7l5.25-5.25M2.75 9H7m0 0v4.25M7 9l-5.25 5.25" })));
var UnfocusToggleIcon_default = SvgUnfocusToggleIcon;

// src/assets/icons/tl/CameraDisabledIcon.tsx
var React60 = __toESM(require("react"));
var SvgCameraDisabledIcon = (props) => /* @__PURE__ */ React60.createElement(
  "svg",
  __spreadValues({
    width: 18,
    height: 18,
...
var SvgCameraIcon = (props) => /* @__PURE__ */ React61.createElement(
  "svg",
  __spreadValues({
    width: 18,
    height: 18,
...
var SvgMicDisabledIcon = (props) => /* @__PURE__ */ React62.createElement(
  "svg",
  __spreadValues({
    width: 18,
    height: 18,
...
var SvgMicIcon2 = (props) => /* @__PURE__ */ React63.createElement(
  "svg",
  __spreadValues({
    width: 18,
    height: 18,
...
var SvgApproveIcon = (props) => /* @__PURE__ */ React64.createElement(
  "svg",
  __spreadValues({
    width: "15",
    height: "11",
...
var SvgRejectIcon = (props) => /* @__PURE__ */ React65.createElement(
  "svg",
  __spreadValues({
    width: "15",
    height: "11",
...
var SvgInviteIcon = (props) => /* @__PURE__ */ React66.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 25, height: 20, fill: "none" }, props), /* @__PURE__ */ React66.createElement(
  "path",
  {
...
var SvgUserIcon = (props) => /* @__PURE__ */ React67.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 20, height: 20, fill: "none" }, props), /* @__PURE__ */ React67.createElement(
  "path",
  {
    id: "Vector",
...
function getSourceIcon(source, enabled) {
  switch (source) {
    case import_livekit_client9.Track.Source.Microphone:
      return enabled ? /* @__PURE__ */ React68.createElement(MicIcon_default2, null) : /* @__PURE__ */ React68.createElement(MicDisabledIcon_default, null);
...
function getConnectionQualityIcon(quality) {
  switch (quality) {
    case import_livekit_client9.ConnectionQuality.Excellent:
      return /* @__PURE__ */ React68.createElement(QualityExcellentIcon_default, null);
    case import_livekit_client9.ConnectionQuality.Good:
      return /* @__PURE__ */ React68.createElement(QualityGoodIcon_default, null);
    case import_livekit_client9.ConnectionQuality.Poor:
      return /* @__PURE__ */ React68.createElement(QualityPoorIcon_default, null);
    default:
      return /* @__PURE__ */ React68.createElement(QualityUnknownIcon_default, null);
  }
}

// src/components/controls/TrackToggle.tsx
var TrackToggle = /* @__PURE__ */ React69.forwardRef(function TrackToggle2(_a2, ref) {
  var _b = _a2, { showIcon } = _b, props = __objRest(_b, ["showIcon"]);
  const { buttonProps, enabled } = useTrackToggle(props);
  return /* @__PURE__ */ React69.createElement("button", __spreadValues({ ref }, buttonProps), (showIcon != null ? showIcon : true) && getSourceIcon(props.source, enabled), props.children);
});
...
var SvgParticipantPlaceholder = (props) => /* @__PURE__ */ React70.createElement(
  "svg",
  __spreadValues({
    width: 320,
    height: 320,
...
function usePreviewTracks(options, onError) {
  const [tracks, setTracks] = React72.useState();
  const trackLock = React72.useMemo(() => new import_livekit_client10.Mutex(), []);
  React72.useEffect(() => {
    ...
    trackLock.lock().then((unlock) => __async(this, null, function* () {
      try {
        if (options.audio || options.video) {
          localTracks = yield (0, import_livekit_client10.createLocalTracks)(options);
          if (needsCleanup) {
        ...
        if (onError && e2 instanceof Error) {
          ...
          import_components_core30.log.error(e2);
        }
      } finally {
        unlock();
      }
...
function usePreviewDevice(enabled, deviceId, kind) {
  const [deviceError, setDeviceError] = React72.useState(null);
  const [isCreatingTrack, setIsCreatingTrack] = React72.useState(false);
  const devices = useMediaDevices({ kind });
  const [selectedDevice, setSelectedDevice] = React72.useState(
    void 0
  );
  const [localTrack, setLocalTrack] = React72.useState();
  const [localDeviceId, setLocalDeviceId] = React72.useState(deviceId);
  React72.useEffect(() => {
    setLocalDeviceId(deviceId);
  }, [deviceId]);
  const createTrack = (deviceId2, kind2) => __async(this, null, function* () {
    try {
      const track = kind2 === "videoinput" ? yield (0, import_livekit_client10.createLocalVideoTrack)({
        deviceId: deviceId2,
        resolution: import_livekit_client10.VideoPresets.h720.resolution
      }) : yield (0, import_livekit_client10.createLocalAudioTrack)({ deviceId: deviceId2 });
  ...
  const prevDeviceId = React72.useRef(localDeviceId);
  React72.useEffect(() => {
    if (enabled && !localTrack && !deviceError && !isCreatingTrack) {
      import_components_core30.log.debug("creating track", kind);
  ...
  React72.useEffect(() => {
    ...
    if (!enabled) {
      import_components_core30.log.debug(`muting ${kind} track`);
      localTrack.mute().then(() => import_components_core30.log.debug(localTrack.mediaStreamTrack));
      ...
      import_components_core30.log.debug(`switching ${kind} device from`, prevDeviceId.current, selectedDevice.deviceId);
      switchDevice(localTrack, selectedDevice.deviceId);
    } else {
      import_components_core30.log.debug(`unmuting local ${kind} track`);
      localTrack.unmute();
    }
  ...
  React72.useEffect(() => {
    return () => {
      if (localTrack) {
        import_components_core30.log.debug(`stopping local ${kind} track`);
        localTrack.stop();
        localTrack.mute();
      }
    };
...
function PreJoin(_a2) {
  ...
  var _a3;
  const [userChoices, setUserChoices] = React72.useState(defaultUserChoices);
  ...
  const [audioEnabled, setAudioEnabled] = React72.useState(initialUserChoices.audioEnabled);
  const [videoEnabled, setVideoEnabled] = React72.useState(initialUserChoices.videoEnabled);
  const [audioDeviceId, setAudioDeviceId] = React72.useState(
    initialUserChoices.audioDeviceId
  );
  const [videoDeviceId, setVideoDeviceId] = React72.useState(
    initialUserChoices.videoDeviceId
  );
  const [username, setUsername] = React72.useState((_a3 = defaults.username) != null ? _a3 : initialUserChoices.username);
  React72.useEffect(() => {
  ...
  const videoTrack = React72.useMemo(
    () => tracks == null ? void 0 : tracks.filter((track) => track.kind === import_livekit_client10.Track.Kind.Video)[0],
    [tracks]
  );
  const facingMode = React72.useMemo(() => {
    if (videoTrack) {
      const { facingMode: facingMode2 } = (0, import_livekit_client10.facingModeFromLocalTrack)(videoTrack);
      return facingMode2;
    } else {
      return "undefined";
    }
  ...
  const audioTrack = React72.useMemo(
    () => tracks == null ? void 0 : tracks.filter((track) => track.kind === import_livekit_client10.Track.Kind.Audio)[0],
    [tracks]
  );
  React72.useEffect(() => {
  ...
  const [isValid, setIsValid] = React72.useState();
  const handleValidation = React72.useCallback(
    (values) => {
  ...
  function handleSubmit(event) {
    ...
    if (handleValidation(userChoices)) {
      ...
      import_components_core30.log.warn("Validation failed with: ", userChoices);
    }
  }
  useWarnAboutMissingStyles();
  return /* @__PURE__ */ React72.createElement("div", __spreadValues({ className: "lk-prejoin" }, htmlProps), /* @__PURE__ */ React72.createElement("div", { className: "lk-video-container" }, videoTrack && /* @__PURE__ */ React72.createElement("video", { ref: videoEl, width: "1280", height: "720", "data-lk-facing-mode": facingMode }), (!videoTrack || !videoEnabled) && /* @__PURE__ */ React72.createElement("div", { className: "lk-camera-off-note" }, /* @__PURE__ */ React72.createElement(ParticipantPlaceholder_default, null))), /* @__PURE__ */ React72.createElement("div", { className: "lk-button-group-container" }, /* @__PURE__ */ React72.createElement("div", { className: "lk-button-group audio" }, /* @__PURE__ */ React72.createElement(
    TrackToggle,
    {
      id: "microphoneButton",
    ...
    micLabel
  ), /* @__PURE__ */ React72.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React72.createElement(
    MediaDeviceMenu,
    {
  ...
  ))), /* @__PURE__ */ React72.createElement("div", { className: "lk-button-group video" }, /* @__PURE__ */ React72.createElement(
    TrackToggle,
    {
      id: "cameraButton",
  ...
  )))), /* @__PURE__ */ React72.createElement("form", { className: "lk-username-container" }, /* @__PURE__ */ React72.createElement(
    "input",
    {
    ...
    joinLabel
  )), debug && /* @__PURE__ */ React72.createElement(React72.Fragment, null, /* @__PURE__ */ React72.createElement("strong", null, "User Choices:"), /* @__PURE__ */ React72.createElement("ul", { className: "lk-list", style: { overflow: "hidden", maxWidth: "15rem" } }, /* @__PURE__ */ React72.createElement("li", null, "Username: ", `${userChoices.username}`), /* @__PURE__ */ React72.createElement("li", null, "Video Enabled: ", `${userChoices.videoEnabled}`), /* @__PURE__ */ React72.createElement("li", null, "Audio Enabled: ", `${userChoices.audioEnabled}`), /* @__PURE__ */ React72.createElement("li", null, "Video Device: ", `${userChoices.videoDeviceId}`), /* @__PURE__ */ React72.createElement("li", null, "Audio Device: ", `${userChoices.audioDeviceId}`))));
}
...
var ChatToggle = /* @__PURE__ */ React73.forwardRef(
  function ChatToggle2(props, ref) {
    const { mergedProps } = useChatToggle({ props });
    return /* @__PURE__ */ React73.createElement("button", __spreadValues({ ref }, mergedProps), props.children);
  }
);
...
function useToggleShareLink({ props }) {
  ...
  const mergedProps = React74.useMemo(
    () => mergeProps2(props, {
      className,
      onClick: () => {
...
function ShareLinkToggle(props) {
  ...
  return /* @__PURE__ */ React74.createElement("button", __spreadValues({}, mergedProps), props.children);
}

// src/components/controls/DisconnectButton.tsx
var React75 = __toESM(require("react"));
var DisconnectButton = /* @__PURE__ */ React75.forwardRef(function DisconnectButton2(props, ref) {
  const { buttonProps } = useDisconnectButton(props);
  return /* @__PURE__ */ React75.createElement("button", __spreadValues({ ref }, buttonProps), props.children);
});
...
var ConnectionQualityIndicator = /* @__PURE__ */ React77.forwardRef(function ConnectionQualityIndicator2(props, ref) {
  ...
  return /* @__PURE__ */ React77.createElement("div", __spreadValues({ ref }, elementProps), (_a2 = props.children) != null ? _a2 : getConnectionQualityIcon(quality));
});

// src/components/participant/ParticipantName.tsx
var import_components_core31 = require("@livekit/components-core");
var React78 = __toESM(require("react"));
var ParticipantName = /* @__PURE__ */ React78.forwardRef(function ParticipantName2(_a2, ref) {
  var _b = _a2, { participant } = _b, props = __objRest(_b, ["participant"]);
  const p2 = useEnsureParticipant(participant);
  const { className, infoObserver } = React78.useMemo(() => {
    return (0, import_components_core31.setupParticipantName)(p2);
  }, [p2]);
...
var TrackMutedIndicator = /* @__PURE__ */ React79.forwardRef(function TrackMutedIndicator2(_a2, ref) {
  ...
  return /* @__PURE__ */ React79.createElement("div", __spreadProps(__spreadValues({ ref }, htmlProps), { "data-lk-muted": isMuted }), (_a3 = props.children) != null ? _a3 : getSourceIcon(trackRef.source, !isMuted));
});
...
function useMediaTrackBySourceOrName(observerOptions, options = {}) {
  var _a2;
  const [publication, setPublication] = React80.useState((0, import_components_core33.getTrackByIdentifier)(observerOptions));
  ...
  const { className, trackObserver } = React80.useMemo(() => {
    return (0, import_components_core33.setupMediaTrack)(observerOptions);
  }, [
    (_a2 = observerOptions.participant.sid) != null ? _a2 : observerOptions.participant.identity,
    observerOptions.source,
    (0, import_components_core32.isTrackReference)(observerOptions) && observerOptions.publication.trackSid
  ]);
  React80.useEffect(() => {
    const subscription = trackObserver.subscribe((publication2) => {
      import_components_core33.log.debug("update track", publication2);
  ...
  React80.useEffect(() => {
    ...
    if (track) {
      ...
      if (((_a3 = options.element) == null ? void 0 : _a3.current) && !((0, import_components_core33.isLocal)(observerOptions.participant) && (track == null ? void 0 : track.kind) === "audio")) {
  ...
  function AudioTrack2(_a2, ref) {
    ...
    React82.useEffect(() => {
      ...
      if (track instanceof import_livekit_client12.RemoteAudioTrack) {
        ...
        import_components_core34.log.warn("Volume can only be set on remote audio tracks.");
      }
    }, [volume, track]);
    React82.useEffect(() => {
      ...
      if (pub instanceof import_livekit_client12.RemoteTrackPublication) {
        ...
        import_components_core34.log.warn("Can only call setEnabled on remote track publications.");
      }
    }, [muted, pub, track]);
  ...
  return /* @__PURE__ */ React86.createElement(React86.Fragment, null, tracks.map((trackReference) => {
    return /* @__PURE__ */ React86.createElement(
      TrackRefContext.Provider,
      {
        ...
        key: (0, import_components_core36.getTrackReferenceId)(trackReference)
      },
...
function InviteViaPhone(_a2) {
  ...
  const [mobile, setMobile] = React99.useState("");
  const [showToast, setShowToast] = React99.useState(false);
  const [countries, setCountries] = React99.useState([]);
  React99.useEffect(() => {
  ...
  const [selectedValue, setSelectedValue] = React99.useState({
    value: "+1",
    label: "+1"
  });
  ...
  return /* @__PURE__ */ React99.createElement("div", __spreadValues({ style }, props), showToast ? /* @__PURE__ */ React99.createElement(Toast, { className: "lk-toast-connection-state" }, "Invitation sent successfully to ", showToast, ".") : /* @__PURE__ */ React99.createElement(React99.Fragment, null), /* @__PURE__ */ React99.createElement("form", { className: "lk-chat-form", style: { display: "flex", alignItems: "center" }, onSubmit: handleSubmit }, /* @__PURE__ */ React99.createElement("div", { style: { minWidth: "100px", maxWidth: "150px" } }, /* @__PURE__ */ React99.createElement(
  ...
  )), /* @__PURE__ */ React99.createElement("input", { className: "lk-form-control lk-chat-form-input", type: "tel", onChange: (e2) => setMobile(e2.target.value), placeholder: "Enter Mobile Number", pattern: "[0-9]+", title: "Enter valid mobile number", maxLength: 10, minLength: 10, value: mobile }), /* @__PURE__ */ React99.createElement("button", { type: "submit", className: "lk-button lk-chat-form-button tl-invite-button" }, "Invite")));
}
...
function InviteViaEmail(_a2) {
  ...
  const [email, setEmail] = React100.useState("");
  function setEmpty() {
    if (email) {
      setEmail("");
    }
  ...
  return /* @__PURE__ */ React100.createElement("div", __spreadValues({}, props), showToast ? /* @__PURE__ */ React100.createElement(Toast, { className: "lk-toast-connection-state" }, "Invitation sent successfully to ", showToast, ".") : /* @__PURE__ */ React100.createElement(React100.Fragment, null), /* @__PURE__ */ React100.createElement("form", { className: "lk-chat-form", onSubmit: handleSubmit }, /* @__PURE__ */ React100.createElement(
    "input",
    {
  ...
  ), /* @__PURE__ */ React100.createElement("button", { type: "submit", className: "lk-button lk-chat-form-button tl-invite-button" }, "Invite")));
}

// src/hooks/useToast.ts
var import_react2 = __toESM(require("react"));
function useToast() {
  const [showToast, setShowToast] = import_react2.default.useState(false);
...
function getToken() {
  ...
  return (_a2 = localStorage.getItem("host")) != null ? _a2 : urlParams.get("token");
}
function ShareLink(_a2) {
  var _b = _a2, { isCallScreen } = _b, props = __objRest(_b, ["isCallScreen"]);
  const inputRef = React102.useRef(null);
  const ulRef = React102.useRef(null);
  const { link } = useGetLink();
  const [users, setUsers] = React102.useState([]);
  const [searched, setSearched] = React102.useState([]);
  const { showToast, setShowToast } = useToast();
  const [inviteVia, setInviteVia] = React102.useState("chat");
  const [invitedUsers, setInvitedUsers] = React102.useState([]);
  const [allowOutsideInvites, setAllowOutsideInvites] = React102.useState(false);
  ...
  const { infoObserver } = React102.useMemo(() => {
    return (0, import_components_core43.setupParticipantName)(p2);
  }, [p2]);
  ...
  const [showInviteUser, setShowInviteUser] = React102.useState(true);
  React102.useEffect(() => {
  ...
  return /* @__PURE__ */ React102.createElement("div", __spreadProps(__spreadValues({}, props), { className: "lk-chat lk-sharelink" }), !isCallScreen && allowOutsideInvites && /* @__PURE__ */ React102.createElement("form", { className: "lk-chat-form" }, /* @__PURE__ */ React102.createElement("input", { className: "lk-form-control lk-chat-form-input", type: "text", value: link, readOnly: true }), /* @__PURE__ */ React102.createElement("button", { type: "button", className: "lk-button lk-chat-form-button", onClick: handleCopy }, "Copy")), showToast ? /* @__PURE__ */ React102.createElement(Toast, { className: "lk-toast-connection-state" }, "Copied") : /* @__PURE__ */ React102.createElement(React102.Fragment, null), /* @__PURE__ */ React102.createElement("div", { className: "tl-invite-buttons" }, /* @__PURE__ */ React102.createElement(
    "button",
    {
      type: "button",
    ...
    "Contact"
  ), allowOutsideInvites && /* @__PURE__ */ React102.createElement(React102.Fragment, null, /* @__PURE__ */ React102.createElement(
    "button",
    {
      type: "button",
      className: "lk-button lk-chat-form-button",
  ...
  )), inviteVia === "chat" ? /* @__PURE__ */ React102.createElement(React102.Fragment, null, showInviteUser ? /* @__PURE__ */ React102.createElement("form", { className: "lk-chat-form", onSubmit: handleSubmit }, /* @__PURE__ */ React102.createElement(
    "input",
    {
      className: "lk-form-control lk-chat-form-input",
      ref: inputRef,
  ...
  )) : /* @__PURE__ */ React102.createElement(React102.Fragment, null), showInviteUser && searched.length > 0 ? /* @__PURE__ */ React102.createElement(
    "ul",
    {
    ...
    searched.map((user) => {
      return /* @__PURE__ */ React102.createElement("li", { key: user.user_id, className: "lk-chat-entry" }, /* @__PURE__ */ React102.createElement("div", { style: { width: "100%" } }, /* @__PURE__ */ React102.createElement("span", { className: "lk-message-body" }, user.full_name), /* @__PURE__ */ React102.createElement("span", { className: "lk-message-body lk-message-text" }, user.designation ? user.designation : user.user_name ? user.user_name != user.full_name ? user.user_name : "-" : "-")), /* @__PURE__ */ React102.createElement(
        "button",
        {
          type: "button",
  ...
  ) : "") : /* @__PURE__ */ React102.createElement(React102.Fragment, null));
}
...
function HostEndMeetingMenu(_a2) {
  ...
  const [isOpen, setIsOpen] = React103.useState(false);
  const [updateRequired, setUpdateRequired] = React103.useState(true);
  const room = useRoomContext();
  const button = React103.useRef(null);
  const leaveButtonRef = React103.useRef(null);
  const tooltip = React103.useRef(null);
  const { disconnect } = (0, import_components_core44.setupDisconnectButton)(room);
  const [showDropdown, setShowDropdown] = React103.useState(false);
  const [value, setValue] = React103.useState("");
  ...
  React103.useLayoutEffect(() => {
    if (button.current && tooltip.current && updateRequired) {
      (0, import_components_core44.computeMenuPosition)(button.current, tooltip.current).then(({ x: x2, y: y2 }) => {
        if (tooltip.current) {
  ...
  const handleClickOutside = React103.useCallback(
    (event) => {
      if (!tooltip.current) {
        return;
      }
      ...
      if (isOpen && (0, import_components_core44.wasClickOutside)(tooltip.current, event)) {
        setIsOpen(false);
  ...
  const [hostError, setHostError] = React103.useState(false);
  const handleChange = () => {
    if (value !== "") {
      setIsOpen(false);
      setValue(value);
  ...
  return /* @__PURE__ */ React103.createElement(React103.Fragment, null, /* @__PURE__ */ React103.createElement(
    ...
    props.children,
    showIcon && /* @__PURE__ */ React103.createElement(LeaveIcon_default, null),
    showText && "Leave"
    ...
    /* @__PURE__ */ React103.createElement("ul", { className: "lk-media-device-select lk-list", style: { display: !showDropdown ? "unset" : "none" } }, endForAll && /* @__PURE__ */ React103.createElement("li", null, /* @__PURE__ */ React103.createElement(DisconnectButton, { onClick: endMeeting }, endForAll)), leave && /* @__PURE__ */ React103.createElement("li", null, /* @__PURE__ */ React103.createElement("button", { ref: leaveButtonRef, className: "lk-disconnect-button", onClick: handleLeave }, "Leave Meeting"))),
    showDropdown && /* @__PURE__ */ React103.createElement("div", { className: "assign-menu" }, hostError && /* @__PURE__ */ React103.createElement("span", { className: "text-invalid" }, "Must have to select participant"), /* @__PURE__ */ React103.createElement("select", { value, onChange: handleChangeValue }, /* @__PURE__ */ React103.createElement("option", { value: "" }, "Select meeting host"), remoteParticipants.map((participant) => /* @__PURE__ */ React103.createElement("option", { value: participant.identity, key: participant.identity }, participant == null ? void 0 : participant.name))), /* @__PURE__ */ React103.createElement("div", { className: "button-container" }, /* @__PURE__ */ React103.createElement("button", { className: "lk-button tl-cancel", onClick: handleCancel }, "Cancel"), /* @__PURE__ */ React103.createElement("button", { className: "lk-button tl-ok", onClick: handleChange }, "Ok"))),
    /* @__PURE__ */ React103.createElement("div", { className: "arrow" }, /* @__PURE__ */ React103.createElement("div", { className: "arrow-shape" }))
  ));
}
...
function useToggleUserLink({ props }) {
  const { dispatch, state } = useLayoutContext().widget;
  const { className } = React104.useMemo(() => (0, import_components_core45.setupUserToggle)(), []);
  const mergedProps = React104.useMemo(
    () => mergeProps2(props, {
      className,
      onClick: () => {
...
function UserToggle(props) {
  ...
  return /* @__PURE__ */ React104.createElement("button", __spreadValues({}, mergedProps), props.children);
}
...
var B = class {
  constructor(t2, e2) {
    if (P(e2), this.Z = t2, null != t2 && 0 === t2.length) throw Error("ByteString should be constructed with non-empty values");
  }
  wa() {
    const t2 = D(this);
...
function X(t2) {
  if ("string" == typeof t2) return { buffer: R(t2), L: false };
  if (Array.isArray(t2)) return { buffer: new Uint8Array(t2), L: false };
  if (t2.constructor === Uint8Array) return { buffer: t2, L: false };
  if (t2.constructor === ArrayBuffer) return { buffer: new Uint8Array(t2), L: false };
  if (t2.constructor === B) return { buffer: D(t2) || O(), L: true };
  if (t2 instanceof Uint8Array) return { buffer: new Uint8Array(t2.buffer, t2.byteOffset, t2.byteLength), L: false };
...
function et(t2, e2) {
  ...
  else z() ? n2 = "" + (BigInt(e2) << BigInt(32) | BigInt(t2)) : (t2 = (16777215 & t2) + 6777216 * (n2 = 16777215 & (t2 >>> 24 | e2 << 8)) + 6710656 * (e2 = e2 >> 16 & 65535), n2 += 8147497 * e2, e2 *= 2, 1e7 <= t2 && (n2 += Math.floor(t2 / 1e7), t2 %= 1e7), 1e7 <= n2 && (e2 += Math.floor(n2 / 1e7), n2 %= 1e7), n2 = e2 + nt(n2) + nt(t2));
  return n2;
}
function nt(t2) {
...
function rt() {
  var t2 = $, e2 = q;
  if (2147483648 & e2) if (z()) t2 = "" + (BigInt(0 | e2) << BigInt(32) | BigInt(t2 >>> 0));
  else {
...
function it(t2) {
  ...
  else if (z()) t2 = BigInt(t2), $ = Number(t2 & BigInt(4294967295)) >>> 0, q = Number(t2 >> BigInt(32) & BigInt(4294967295));
  else {
    const e2 = +("-" === t2[0]);
    q = $ = 0;
    const n2 = t2.length;
...
function ot(t2, e2) {
  ...
  if (pt(t2, a2), 128 > n2) return e2(r2 >>> 0, i2 >>> 0);
  throw G();
}
function at(t2) {
  let e2 = 0, n2 = t2.g;
  ...
  for (; n2 < r2; ) {
    const r3 = i2[n2++];
    if (e2 |= r3, 0 == (128 & r3)) return pt(t2, n2), !!(127 & e2);
  }
  throw G();
}
function ct(t2) {
  ...
  if (128 & r2 && (r2 = e2[n2++], i2 |= (127 & r2) << 7, 128 & r2 && (r2 = e2[n2++], i2 |= (127 & r2) << 14, 128 & r2 && (r2 = e2[n2++], i2 |= (127 & r2) << 21, 128 & r2 && (r2 = e2[n2++], i2 |= r2 << 28, 128 & r2 && 128 & e2[n2++] && 128 & e2[n2++] && 128 & e2[n2++] && 128 & e2[n2++] && 128 & e2[n2++]))))) throw G();
  return pt(t2, n2), i2;
}
function ht(t2) {
  return ct(t2) >>> 0;
...
function _t(t2) {
  switch (t2.h) {
    ...
    case 3:
      for (e2 = t2.m; ; ) {
        if (!vt(t2)) throw Error("Unmatched start-group tag: stream EOF");
        if (4 == t2.h) {
...
function he(t2, e2, n2) {
  if (null != t2) {
    if ("string" == typeof t2) t2 = t2 ? new B(t2, I) : U();
    else if (t2.constructor !== B) if (F(t2)) t2 = n2 ? V(t2) : t2.length ? new B(new Uint8Array(t2), I) : U();
    else {
      if (!e2) throw Error();
      t2 = void 0;
    }
...
function Ce(t2, e2, n2, r2) {
  if (null != t2 && "object" == typeof t2 && t2.W === ie) return t2;
  if (!Array.isArray(t2)) return n2 ? 2 & r2 ? (t2 = e2[Wt]) ? e2 = t2 : (te((t2 = new e2()).s), e2 = e2[Wt] = t2) : e2 = new e2() : e2 = void 0, e2;
  let i2 = n2 = qt(t2);
...
function je(t2, e2, n2) {
  if (null == t2 && (t2 = Ue), Ue = void 0, null == t2) {
    ...
    if (64 & (r2 = qt(t2))) return ye && delete t2[ye], t2;
    ...
    t: {
      ...
      if (i2) {
        const t3 = i2 - 1;
        if (ae(n2[t3])) {
          if (1024 <= (e2 = t3 - (+!!(512 & (r2 |= 256)) - 1))) throw Error();
          r2 = -16760833 & r2 | (1023 & e2) << 14;
          break t;
        }
      }
      if (e2) {
        if (1024 < (e2 = Math.max(e2, i2 - (+!!(512 & r2) - 1)))) throw Error();
        r2 = -16760833 & r2 | (1023 & e2) << 14;
      }
    }
  }
...
function He(t2) {
  if (2 & t2.O) throw Error("Cannot mutate an immutable Map");
}
...
function Je(t2, e2, n2, r2, i2, s2) {
  if (null != t2) {
    if (Array.isArray(t2)) t2 = i2 && 0 == t2.length && 1 & qt(t2) ? void 0 : s2 && 2 & qt(t2) ? t2 : Ze(t2, e2, n2, void 0 !== r2, i2, s2);
    else if (ae(t2)) {
      const o2 = {};
      for (let a2 in t2) o2[a2] = Je(t2[a2], e2, n2, r2, i2, s2);
      t2 = o2;
    } else t2 = e2(t2, r2);
    return t2;
  }
...
function Ze(t2, e2, n2, r2, i2, s2) {
  ...
  r2 = r2 ? !!(32 & o2) : void 0;
  const a2 = Vt(t2);
  for (let t3 = 0; t3 < a2.length; t3++) a2[t3] = Je(a2[t3], e2, n2, r2, i2, s2);
...
function tn(t2) {
  return t2.W === ie ? t2.toJSON() : t2 instanceof Ye ? t2.pa(Qe) : function(t3) {
    switch (typeof t3) {
      ...
      case "object":
        if (t3) {
          if (Array.isArray(t3)) return ce || !ue(t3, void 0, 9999) ? t3 : void 0;
          if (F(t3)) return x(t3);
          if (t3 instanceof B) {
            const e2 = t3.Z;
            return null == e2 ? "" : "string" == typeof e2 ? e2 : t3.Z = x(e2);
          }
          if (t3 instanceof Ye) return t3 = t3.pa(), W || 0 !== t3.length ? t3 : void 0;
        }
    }
    return t3;
  }(t2);
...
function wn(t2, e2, n2) {
  {
    const o2 = t2.s;
    let a2 = Jt(o2);
    if (de(a2), null == n2) hn(o2, a2, e2);
    else {
      var r2, i2 = t2 = qt(n2), s2 = !!(2 & t2) || Object.isFrozen(n2);
      if ((r2 = !s2) && (r2 = false), !(4 & t2)) for (t2 = 21, s2 && (n2 = Vt(n2), i2 = 0, t2 = On(t2, a2, true)), s2 = 0; s2 < n2.length; s2++) n2[s2] = Me(n2[s2]);
...
function xn(t2, e2, n2, r2) {
  ...
  let o2;
  if (null != s2 && s2.W === ie) return (e2 = sn(s2)) !== s2 && hn(t2, i2, n2, e2, r2), e2.s;
  if (Array.isArray(s2)) {
    const t3 = qt(s2);
    o2 = 2 & t3 ? rn(s2, t3, false) : s2, o2 = Ge(o2, e2);
  } else o2 = Ge(void 0, e2);
...
function Sn(t2, e2, n2, r2 = false) {
  if (null == (e2 = kn(t2, e2, n2, r2))) return e2;
  t2 = t2.s;
  let i2 = Jt(t2);
  if (!(2 & i2)) {
    const s2 = sn(e2);
...
function Ln(t2, e2, n2, r2, i2, s2) {
  ...
  if (n2 = !!(8 & h2) || c2 && !o2.length, s2 && !n2) {
    for (mn(h2) && (o2 = Vt(o2), h2 = On(h2, e2, i2), e2 = hn(t2, e2, r2, o2)), s2 = o2, n2 = h2, l2 = 0; l2 < s2.length; l2++) (h2 = s2[l2]) !== (f2 = sn(h2)) && (s2[l2] = f2);
...
function Xn(t2, e2, n2) {
  ...
  if (ae(l2 = e2[c2 - 1])) {
    t: {
      var p2 = l2;
      for (var g2 in s2 = {}, n2 = false, p2) t2 = p2[g2], Array.isArray(t2) && (a2 = t2, (!H && ue(t2, r2, +g2) || !W && oe(t2) && 0 === t2.size) && (t2 = null), t2 != a2 && (n2 = true)), null != t2 ? s2[g2] = t2 : n2 = true;
      if (n2) {
        for (let t3 in s2) {
          p2 = s2;
          break t;
  ...
  for (i2 = +!!(512 & i2) - 1; 0 < c2 && (null == (l2 = e2[g2 = c2 - 1]) || !H && ue(l2, r2, g2 - i2) || !W && oe(l2) && 0 === l2.size); c2--) d2 = true;
...
function pr(t2, e2, n2) {
  ...
  if (256 & r2) {
    r2 = t2[s2 - 1];
    for (let t3 in r2) i2 = +t3, Number.isNaN(i2) || null != (s2 = r2[t3]) && (a2 = dr(n2, i2)) && a2(e2, s2, i2);
  }
  if (t2 = me ? t2[me] : void 0) for (Pt(e2, e2.g.end()), n2 = 0; n2 < t2.length; n2++) Pt(e2, D(t2[n2]) || O());
}
function gr(t2, e2) {
...
var Fr = mr(kr, function(t2, e2, n2) {
  if (null != (e2 = Wn(we, e2))) for (let o2 = 0; o2 < e2.length; o2++) {
...
var Mr = mr(kr, function(t2, e2, n2) {
  if (null != (e2 = Wn(we, e2)) && e2.length) {
    ...
    for (let r2 = 0; r2 < e2.length; r2++) n2 = t2.g, Z(e2[r2]), Ct(n2, $);
  }
});
...
var Ur = mr(function(t2, e2, n2) {
  ...
  if (null != (e2 = Wn(Ae, e2)) && e2.length) {
    n2 = Dt(t2, n2);
    for (let n3 = 0; n3 < e2.length; n3++) It(t2.g, e2[n3]);
    Bt(t2, n2);
  }
});
...
var Gr = mr(function(t2, e2, n2) {
  ...
  if (null != (e2 = Wn(Ie, e2))) for (let o2 = 0; o2 < e2.length; o2++) {
    var r2 = t2, i2 = n2, s2 = e2[o2];
...
Sr = new jt(function(t2, e2, n2, r2, i2) {
  ...
  if (Array.isArray(e2)) for (let s2 = 0; s2 < e2.length; s2++) Ar(t2, e2[s2], n2, r2, i2);
}, true, true);
...
var Yr = mr(function(t2, e2, n2) {
  ...
  if (null != (e2 = Wn(xe, e2))) for (let o2 = 0; o2 < e2.length; o2++) {
    var r2 = t2, i2 = n2, s2 = e2[o2];
  ...
  g() {
    ...
    return t2 = function(t3, e3, n3) {
      ...
      if (null == n3) {
        ...
        if (0 == (2 & n3.O) || i2) return n3;
        n3 = n3.X();
      } else Array.isArray(n3) ? s2 = !!(2 & qt(n3)) : n3 = [];
      if (i2) {
        if (!n3.length) return vn();
        s2 || (s2 = true, te(n3));
      } else s2 && (s2 = false, n3 = _n(n3));
...
function xo(t2) {
  ...
  for (let t3 = 0; t3 < e2.length; t3++) s2.categories.push({ score: e2[t3], index: (_a2 = n2[t3]) != null ? _a2 : -1, categoryName: (_b = r2[t3]) != null ? _b : "", displayName: (_c2 = i2[t3]) != null ? _c2 : "" });
  if ((e2 = (_d = Sn(t2, Hi, 4)) == null ? void 0 : _d.h()) && (s2.boundingBox = { originX: (_e2 = Cn(e2, 1)) != null ? _e2 : 0, originY: (_f = Cn(e2, 2)) != null ? _f : 0, width: (_g = Cn(e2, 3)) != null ? _g : 0, height: (_h = Cn(e2, 4)) != null ? _h : 0, angle: 0 }), (_i2 = Sn(t2, Hi, 4)) == null ? void 0 : _i2.g().length) for (const e3 of Sn(t2, Hi, 4).g()) s2.keypoints.push({ x: (_j = ln(e3, 1)) != null ? _j : 0, y: (_k = ln(e3, 2)) != null ? _k : 0, score: (_l = ln(e3, 4)) != null ? _l : 0, label: (_m = Pn(e3, 3)) != null ? _m : "" });
  return s2;
}
function ko(t2) {
  var _a2, _b, _c2;
  const e2 = [];
  for (const n2 of Rn(t2, ts, 1)) e2.push({ x: (_a2 = Dn(n2, 1)) != null ? _a2 : 0, y: (_b = Dn(n2, 2)) != null ? _b : 0, z: (_c2 = Dn(n2, 3)) != null ? _c2 : 0 });
  return e2;
}
function So(t2) {
  var _a2, _b, _c2;
  const e2 = [];
  for (const n2 of Rn(t2, qi, 1)) e2.push({ x: (_a2 = Dn(n2, 1)) != null ? _a2 : 0, y: (_b = Dn(n2, 2)) != null ? _b : 0, z: (_c2 = Dn(n2, 3)) != null ? _c2 : 0 });
  return e2;
}
function Lo(t2) {
...
function Vo(t2, e2, n2, r2) {
  return __async(this, null, function* () {
    return t2 = yield ((t3, e3, n3, r3, i2) => __async(this, null, function* () {
      if (e3 && (yield Uo(e3)), !self.ModuleFactory) throw Error("ModuleFactory not set.");
      if (n3 && (yield Uo(n3), !self.ModuleFactory)) throw Error("ModuleFactory not set.");
...
function zo(t2) {
  try {
    ...
    if (1 === e2) throw Error(t2.F[0].message);
    if (1 < e2) throw Error("Encountered multiple errors: " + t2.F.map((t3) => t3.message).join(", "));
  } finally {
    t2.F = [];
  }
}
...
var $o = class {
  ...
  l(t2, e2 = true) {
    ...
    if (e2) {
      ...
      if (!(((_c2 = Sn(this.baseOptions, As, 1)) == null ? void 0 : _c2.g()) || ((_d = Sn(this.baseOptions, As, 1)) == null ? void 0 : _d.h()) || ((_e2 = t2.baseOptions) == null ? void 0 : _e2.modelAssetBuffer) || ((_f = t2.baseOptions) == null ? void 0 : _f.modelAssetPath))) throw Error("Either baseOptions.modelAssetPath or baseOptions.modelAssetBuffer must be set");
      if (function(t3, e4) {
...
var sa = class {
  ...
  m() {
    const t2 = this.g;
    if (this.h = qo(t2.createProgram(), "Failed to create WebGL program"), this.ta = Zo(this, "\n  attribute vec2 aVertex;\n  attribute vec2 aTex;\n  varying vec2 vTex;\n  void main(void) {\n    gl_Position = vec4(aVertex, 0.0, 1.0);\n    vTex = aTex;\n  }", t2.VERTEX_SHADER), this.sa = Zo(this, this.I(), t2.FRAGMENT_SHADER), t2.linkProgram(this.h), !t2.getProgramParameter(this.h, t2.LINK_STATUS)) throw Error(`Error during program linking: ${t2.getProgramInfoLog(this.h)}`);
  ...
  ea(i2, s2, true, () => {
    !function(t4, e3, n3, r3) {
      ...
      if (i3.activeTexture(i3.TEXTURE0), i3.bindTexture(i3.TEXTURE_2D, e3), i3.activeTexture(i3.TEXTURE1), i3.bindTexture(i3.TEXTURE_2D, t4.B), i3.texImage2D(i3.TEXTURE_2D, 0, i3.RGBA, i3.RGBA, i3.UNSIGNED_BYTE, n3), t4.J && function(t5, e4) {
        ...
        return !!e4.next().done;
      }(t4.J, r3)) i3.activeTexture(i3.TEXTURE2), i3.bindTexture(i3.TEXTURE_2D, t4.j);
      else {
        t4.J = r3;
...
var La = class {
  ...
  Ea(t2, e2) {
    if (t2) {
      ...
      for (const s2 of t2) n2.fillStyle = Ta(e2.fillColor, { index: i2, from: s2 }), n2.strokeStyle = Ta(e2.color, { index: i2, from: s2 }), n2.lineWidth = Ta(e2.lineWidth, { index: i2, from: s2 }), (t2 = new Path2D()).arc(s2.x * r2.width, s2.y * r2.height, Ta(e2.radius, { index: i2, from: s2 }), 0, 2 * Math.PI), n2.fill(t2), n2.stroke(t2), ++i2;
      n2.restore();
    }
  }
  Da(t2, e2, n2) {
...
function za(t2, e2, n2, r2) {
  if (t2.J) {
    ...
    if (n2 == null ? void 0 : n2.regionOfInterest) {
      if (!t2.U) throw Error("This task doesn't support region-of-interest.");
    ...
    if (n2 == null ? void 0 : n2.rotationDegrees) {
      if (0 != (n2 == null ? void 0 : n2.rotationDegrees) % 90) throw Error("Expected rotation to be a multiple of 90\xB0.");
...
var Ka = class extends $o {
  ...
  l(t2, e2 = true) {
    if ("runningMode" in t2 && Bn(this.baseOptions, 2, !!t2.runningMode && "IMAGE" !== t2.runningMode), void 0 !== t2.canvas && this.g.i.canvas !== t2.canvas) throw Error("You must create a new task to reset the canvas.");
...
var $a = class extends Ka {
  ...
  m() {
    ...
    vi(n2, "mediapipe.tasks.vision.face_detector.FaceDetectorGraph"), _i(n2, "IMAGE:image_in"), _i(n2, "NORM_RECT:norm_rect_in"), wi(n2, "DETECTIONS:detections"), n2.o(e2), Si(t2, n2), this.g.attachProtoVectorListener("detections", (t3, e3) => {
      for (const e4 of t3) t3 = $i(e4), this.j.detections.push(xo(t3));
      Wo(this, e3);
...
var ac = class extends Ka {
  ...
  m() {
    ...
    vi(n2, "mediapipe.tasks.vision.face_landmarker.FaceLandmarkerGraph"), _i(n2, "IMAGE:image_in"), _i(n2, "NORM_RECT:norm_rect"), wi(n2, "NORM_LANDMARKS:face_landmarks"), n2.o(e2), Si(t2, n2), this.g.attachProtoVectorListener("face_landmarks", (t3, e3) => {
      for (const e4 of t3) t3 = rs(e4), this.j.faceLandmarks.push(ko(t3));
      Wo(this, e3);
      ...
      var _a2;
      if (this.outputFaceBlendshapes) for (const e4 of t3) t3 = Bi(e4), this.j.faceBlendshapes.push(Ao((_a2 = t3.g()) != null ? _a2 : []));
      Wo(this, e3);
      ...
      var _a2, _b, _c2;
      if (this.outputFacialTransformationMatrixes) for (const e4 of t3) (t3 = Sn(Is(e4), is, 2)) && this.j.facialTransformationMatrixes.push({ rows: (_a2 = Un(Cn(t3, 1))) != null ? _a2 : 0, columns: (_b = Un(Cn(t3, 2))) != null ? _b : 0, data: (_c2 = dn(t3, 3, we)) != null ? _c2 : [] });
      Wo(this, e3);
...
var cc = class extends Ka {
  ...
  Ua(t2, e2, n2) {
    ...
    if (this.h = "function" == typeof e2 ? e2 : n2, Wa(this, t2, r2 != null ? r2 : {}), !this.h) return this.u;
  }
  m() {
    var t2 = new Fi();
...
function fc(t2, e2 = true) {
  ...
  for (const i2 of t2) {
    var r2 = Bi(i2);
    t2 = [];
    for (const n3 of r2.g()) r2 = e2 && null != Cn(n3, 1) ? Un(Cn(n3, 1)) : -1, t2.push({ score: (_a2 = Dn(n3, 2)) != null ? _a2 : 0, index: r2, categoryName: (_c2 = (_b = Pn(n3, 3)) != null ? _b : "") != null ? _c2 : "", displayName: (_e2 = (_d = Pn(n3, 4)) != null ? _d : "") != null ? _e2 : "" });
    n2.push(t2);
  }
  return n2;
}
var dc = class extends Ka {
  ...
  o(t2) {
    ...
    } else void 0 === t2.cannedGesturesClassifierOptions && ((_f = Sn(this.j, Vs, 3)) == null ? void 0 : _f.g());
  ...
  m() {
    ...
    vi(n2, "mediapipe.tasks.vision.gesture_recognizer.GestureRecognizerGraph"), _i(n2, "IMAGE:image_in"), _i(n2, "NORM_RECT:norm_rect"), wi(n2, "HAND_GESTURES:hand_gestures"), wi(n2, "LANDMARKS:hand_landmarks"), wi(n2, "WORLD_LANDMARKS:world_hand_landmarks"), wi(n2, "HANDEDNESS:handedness"), n2.o(e2), Si(t2, n2), this.g.attachProtoVectorListener("hand_landmarks", (t3, e3) => {
      ...
      for (const e4 of t3) {
        t3 = rs(e4);
        const n3 = [];
        for (const e5 of Rn(t3, ts, 1)) n3.push({ x: (_a2 = Dn(e5, 1)) != null ? _a2 : 0, y: (_b = Dn(e5, 2)) != null ? _b : 0, z: (_c2 = Dn(e5, 3)) != null ? _c2 : 0 });
      ...
      for (const e4 of t3) {
        t3 = Qi(e4);
        const n3 = [];
        for (const e5 of Rn(t3, qi, 1)) n3.push({ x: (_a2 = Dn(e5, 1)) != null ? _a2 : 0, y: (_b = Dn(e5, 2)) != null ? _b : 0, z: (_c2 = Dn(e5, 3)) != null ? _c2 : 0 });
...
var gc = class extends Ka {
  ...
  m() {
    ...
    vi(n2, "mediapipe.tasks.vision.hand_landmarker.HandLandmarkerGraph"), _i(n2, "IMAGE:image_in"), _i(n2, "NORM_RECT:norm_rect"), wi(n2, "LANDMARKS:hand_landmarks"), wi(n2, "WORLD_LANDMARKS:world_hand_landmarks"), wi(n2, "HANDEDNESS:handedness"), n2.o(e2), Si(t2, n2), this.g.attachProtoVectorListener("hand_landmarks", (t3, e3) => {
      for (const e4 of t3) t3 = rs(e4), this.landmarks.push(ko(t3));
      Wo(this, e3);
    }), this.g.attachEmptyPacketListener("hand_landmarks", (t3) => {
      Wo(this, t3);
    }), this.g.attachProtoVectorListener("world_hand_landmarks", (t3, e3) => {
      for (const e4 of t3) t3 = Qi(e4), this.worldLandmarks.push(So(t3));
      Wo(this, e3);
    }), this.g.attachEmptyPacketListener("world_hand_landmarks", (t3) => {
      Wo(this, t3);
    }), this.g.attachProtoVectorListener("handedness", (t3, e3) => {
      ...
      for (const e4 of t3) {
        t3 = Bi(e4);
        const n4 = [];
        for (const e5 of t3.g()) n4.push({ score: (_a2 = Dn(e5, 2)) != null ? _a2 : 0, index: (_b = Un(Cn(e5, 1))) != null ? _b : -1, categoryName: (_d = (_c2 = Pn(e5, 3)) != null ? _c2 : "") != null ? _d : "", displayName: (_f = (_e2 = Pn(e5, 4)) != null ? _e2 : "") != null ? _f : "" });
        i2.push(n4);
      }
    ...
    vi(n2, "mediapipe.tasks.vision.image_embedder.ImageEmbedderGraph"), _i(n2, "IMAGE:image_in"), _i(n2, "NORM_RECT:norm_rect"), wi(n2, "EMBEDDINGS:embeddings_out"), n2.o(e2), Si(t2, n2), this.g.attachProtoListener("embeddings_out", (t3, e3) => {
      t3 = ys(t3), this.embeddings = function(t4) {
        return { embeddings: Rn(t4, ds, 1).map((t5) => {
          ...
          if (void 0 !== kn(t5, ls, bn(t5, 1))) t5 = dn(t5 = Sn(t5, ls, bn(t5, 1)), 1, we), e4.floatEmbedding = t5;
          else {
...
yc.cosineSimilarity = function(t2, e2) {
  if (t2.floatEmbedding && e2.floatEmbedding) t2 = Ro(t2.floatEmbedding, e2.floatEmbedding);
  else {
...
var Vc = class extends Ka {
  ...
  ea(t2, e2, n2, r2) {
    ...
    const s2 = new Dc();
    var o2 = new bc();
    if (Nn(o2, 1, 255), Fn(s2, 0, 12, o2), e2.keypoint && e2.scribble) throw Error("Cannot provide both keypoint and scribble.");
    if (e2.keypoint) {
      var a2 = new Cc();
      ...
      for (a2 of (o2 = new Uc(), e2.scribble)) Bn(e2 = new Cc(), 3, true), Gn(e2, 1, a2.x), Gn(e2, 2, a2.y), In(o2, Cc, e2);
      Mn(s2, 15, Bc, o2);
    }
...
// ../../node_modules/.pnpm/@livekit+track-processors@0.3.2_livekit-client@2.1.0/node_modules/@livekit/track-processors/dist/index.mjs
...
var BackgroundProcessor = class _this extends VideoTransformer {
  ...
  init(_0) {
    return __async(this, arguments, function* ({ outputCanvas, inputElement: inputVideo }) {
      ...
      if (((_e2 = this.options) == null ? void 0 : _e2.imagePath) && !this.backgroundImage) {
        yield this.loadBackground(this.options.imagePath).catch((err) => console.error("Error while loading processor background image: ", err));
      }
    });
  }
  destroy() {
...
function ExtraOptionMenu(_a2) {
  ...
  const blurButtonRef = React107.useRef(null);
  const tooltip = React107.useRef(null);
  const [showDropdown, setShowDropdown] = React107.useState(false);
  React107.useLayoutEffect(() => {
    if (button.current && tooltip.current && updateRequired) {
      (0, import_components_core46.computeMenuPosition)(button.current, tooltip.current).then(({ x: x2, y: y2 }) => {
        if (tooltip.current) {
          Object.assign(tooltip.current.style, { left: `${x2}px`, top: `${y2 + 5}px` });
        }
      });
  ...
  return /* @__PURE__ */ React107.createElement(React107.Fragment, null, /* @__PURE__ */ React107.createElement(
    ...
    /* @__PURE__ */ React107.createElement("ul", { className: "lk-media-device-select lk-list", style: { display: !showDropdown ? "unset" : "none" } }, /* @__PURE__ */ React107.createElement("li", null, /* @__PURE__ */ React107.createElement(WhiteboardIndicater, { shareScreenTracks, parentCallback: changeState })), blurEnabled && /* @__PURE__ */ React107.createElement("li", null, /* @__PURE__ */ React107.createElement(BlurIndicater, { source: import_livekit_client16.Track.Source.Camera, parentCallback: changeState }))),
    /* @__PURE__ */ React107.createElement("div", { className: "arrow" }, /* @__PURE__ */ React107.createElement("div", { className: "arrow-shape" }))
  ));
}

// src/components/controls/StartMediaButton.tsx
var React108 = __toESM(require("react"));
var StartMediaButton = /* @__PURE__ */ React108.forwardRef(function StartMediaButton2(_a2, ref) {
  ...
  return /* @__PURE__ */ React108.createElement("button", __spreadValues({ ref, style }, restProps), label != null ? label : `Start ${!canPlayAudio ? "Audio" : "Video"}`);
});
...
function useSettingsToggle({ props }) {
  ...
  const mergedProps = React109.useMemo(() => {
    return mergeProps(props, {
      className,
      onClick: () => {
...
// src/components/controls/SettingsMenuToggle.tsx
var SettingsMenuToggle = /* @__PURE__ */ React110.forwardRef(function SettingsMenuToggle2(props, ref) {
  const { mergedProps } = useSettingsToggle({ props });
  return /* @__PURE__ */ React110.createElement("button", __spreadValues({ ref }, mergedProps), props.children);
});
...
function RecordingControls({ onRecordingChange }) {
  ...
  const [authKey, setAuthKey] = (0, import_react5.useState)(null);
  ...
  return /* @__PURE__ */ import_react5.default.createElement("div", { className: "relative" }, isOpen && /* @__PURE__ */ import_react5.default.createElement("div", { ref: menuRef, style: { position: "absolute", bottom: "60px" } }, /* @__PURE__ */ import_react5.default.createElement("ul", { className: "lk-recording-menu" }, /* @__PURE__ */ import_react5.default.createElement("li", null, /* @__PURE__ */ import_react5.default.createElement(
    "button",
    {
      onClick: () => {
    ...
    isLoading ? "Processing..." : /* @__PURE__ */ import_react5.default.createElement(import_react5.default.Fragment, null, /* @__PURE__ */ import_react5.default.createElement(MicIcon_default, null), isRecording ? "Stop Recording" : "Start Recording"),
...
function ControlBar(_a2) {
  ...
  const browserSupportsScreenSharing = (0, import_components_core47.supportsScreenSharing)();
  ...
  const [sharescreenTitle, setSharescreenTitle] = React113.useState("You can share your screen");
  React113.useEffect(() => {
    if (!isScreenShareEnabled && screenShareTracks !== 0) {
  ...
  ))), visibleControls.camera && /* @__PURE__ */ React113.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React113.createElement(TrackToggle, { source: import_livekit_client17.Track.Source.Camera, showIcon, onChange: cameraOnChange }, showText && "Camera"), /* @__PURE__ */ React113.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React113.createElement(
    MediaDeviceMenu,
    {
      kind: "videoinput",
  ...
  ))) : /* @__PURE__ */ React113.createElement(DisconnectButton, null, showIcon && /* @__PURE__ */ React113.createElement(LeaveIcon_default, null), showText && visibleControls.leaveButton), visibleControls.settings && /* @__PURE__ */ React113.createElement(SettingsMenuToggle, null, showIcon && /* @__PURE__ */ React113.createElement(GearIcon_default, null), showText && "Settings"), /* @__PURE__ */ React113.createElement(StartMediaButton, null));
}
...
var ParticipantList = (_a2) => {
  ...
  return /* @__PURE__ */ React114.createElement("div", __spreadValues({ style: { position: "relative" } }, elementProps), /* @__PURE__ */ React114.createElement(ParticipantContextIfNeeded, { participant: p2 }, children != null ? children : /* @__PURE__ */ React114.createElement(React114.Fragment, null, /* @__PURE__ */ React114.createElement("div", { className: "lk-participant-metadata" }, /* @__PURE__ */ React114.createElement("div", { className: "lk-participant-metadata-item" }, /* @__PURE__ */ React114.createElement(ParticipantName, null)), /* @__PURE__ */ React114.createElement("div", { className: "display-flex" }, /* @__PURE__ */ React114.createElement(
    TrackMutedIndicator,
    {
      trackRef: {
        participant: p2,
...
function Users(_a2) {
  ...
  const ulRef = React116.useRef(null);
  const participants = useParticipants();
  const [waitingRoom, setWaitingRoom] = React116.useState([]);
  const [toggleWaiting, setToggleWaiting] = React116.useState(true);
  const room = useRoomContext();
  ...
  return /* @__PURE__ */ React116.createElement("div", __spreadProps(__spreadValues({}, props), { className: "lk-chat lk-users" }), /* @__PURE__ */ React116.createElement("div", { className: "lk-waitinroom" }, /* @__PURE__ */ React116.createElement("div", { className: "tl-waitingroom-heading" }, /* @__PURE__ */ React116.createElement("h3", null, "Waiting Room"), /* @__PURE__ */ React116.createElement("div", { className: "tl-toggle-switch" }, /* @__PURE__ */ React116.createElement(
    ToggleSwitch,
    {
      id: "toggleSwitch",
  ...
  )), toggleWaiting && waitingRoom.length ? /* @__PURE__ */ React116.createElement(
    "button",
    {
    ...
    "Approve All"
  ) : ""), waitingRoom.map((item) => /* @__PURE__ */ React116.createElement("div", { className: "tl-participant-li", key: item.username }, /* @__PURE__ */ React116.createElement("div", { className: "lk-participant-metadata" }, /* @__PURE__ */ React116.createElement("div", { className: "lk-participant-metadata-item" }, item.username), /* @__PURE__ */ React116.createElement("div", { className: "display-flex" }, /* @__PURE__ */ React116.createElement(
    "button",
    {
      className: "lk-button lk-waiting-room lk-success",
      onClick: () => admitUser(item.identity, "accepted")
    },
    /* @__PURE__ */ React116.createElement(ApproveIcon_default, null)
    ...
    /* @__PURE__ */ React116.createElement(RejectIcon_default, null)
  )))))), /* @__PURE__ */ React116.createElement("div", { className: "lk-participants" }, /* @__PURE__ */ React116.createElement("div", { className: "tl-participants-heading" }, /* @__PURE__ */ React116.createElement("h3", null, "Participants  ", /* @__PURE__ */ React116.createElement("span", null, "(", participants.length, ")"))), (participants == null ? void 0 : participants.length) ? /* @__PURE__ */ React116.createElement(ParticipantLoop, { participants }, /* @__PURE__ */ React116.createElement(ParticipantList, null)) : /* @__PURE__ */ React116.createElement("div", null, /* @__PURE__ */ React116.createElement("h5", null, "No Participants"))));
}
...
function CallUser(_a2) {
  ...
  var _a3;
  const participants = useParticipants();
  let [contacts, setContacts] = React117.useState([]);
  let [allcontacts, setAllContacts] = React117.useState([]);
  const inputRef = React117.useRef(null);
  const [selectedOption, setSelectedOption] = React117.useState("phone");
  const [mobile, setMobile] = React117.useState("");
  const [email, setEmail] = React117.useState("");
  const [disableButton, setdisableButton] = React117.useState(false);
  const room = useRoomContext();
  let CHAT_SERVER_URL = room.metadata ? JSON.parse(room.metadata).app_url : "";
  const [activeTab, setActiveTab] = React117.useState("contacts");
  const [invitedUsers, setInvitedUsers] = React117.useState(contactsList);
  const [timeoutIds, setTimeoutIds] = React117.useState([]);
  const [countries, setCountries] = React117.useState([]);
  const [selectedValue, setSelectedValue] = React117.useState({
    value: "+1",
    label: "+1"
  });
  const { showToast, setShowToast } = useToast();
  ...
  function calling(id) {
    return __async(this, null, function* () {
      ...
      const timeoutId = setTimeout(() => {
        setInvitedUsers(
          (prevUsers) => prevUsers.filter((userId) => userId !== id)
        );
      }, 3e4);
  ...
  function usersList2() {
    return __async(this, null, function* () {
      ...
      const sortedContacts = originalContacts.sort((a2, b2) => {
        const nameA = a2.full_name.toLowerCase();
        const nameB = b2.full_name.toLowerCase();
        if (nameA < nameB) {
          return -1;
        }
        if (nameA > nameB) {
  ...
  const handleSearch = (e2) => {
    var _a4;
    e2.preventDefault();
    const searchTerm2 = (((_a4 = inputRef.current) == null ? void 0 : _a4.value) || "").toLowerCase().trim();
    if (searchTerm2) {
      const filteredContacts2 = allcontacts.filter((item) => {
        const userMatch = item.user_name.toLowerCase().includes(searchTerm2);
        const fullNameMatch = item.full_name.toLowerCase().includes(searchTerm2);
        return userMatch || fullNameMatch;
      });
      setContacts(filteredContacts2);
    } else {
      setContacts(allcontacts);
    }
  };
  ...
  const ulRef2 = React117.useRef(null);
  ...
  const filteredContacts = contacts.filter((contact) => {
    const isInParticipants = participants.some(
      (participant) => participant.identity === contact.user_id || participant.participantInfo && participant.participantInfo.identity === contact.user_id
    );
    return !isInParticipants;
  });
  const ParticipatedContacts = participants.map((participant) => {
    const matchingContact = contacts.find(
      (contact) => contact.user_id === participant.participantInfo.identity
    );
    if (matchingContact) {
      return __spreadProps(__spreadValues({}, matchingContact), {
        full_name: matchingContact ? matchingContact.full_name : participant.participantInfo.name
      });
    } else {
      return __spreadProps(__spreadValues({}, matchingContact), {
        full_name: matchingContact ? matchingContact.full_name : participant.participantInfo.name
  ...
  const searchTerm = (((_a3 = inputRef.current) == null ? void 0 : _a3.value) || "").toLowerCase().trim();
  const filteredParticipants = searchTerm ? ParticipatedContacts.filter(
    (item) => item.full_name.toLowerCase().includes(searchTerm) || item.designation && item.designation.toLowerCase().includes(searchTerm)
  ) : ParticipatedContacts;
  const sendInvite = (e2) => __async(this, null, function* () {
    e2.preventDefault();
    setdisableButton(true);
    let roomName = room == null ? void 0 : room.name;
    if (selectedOption === "phone" && selectedValue.value && mobile || selectedOption === "email" && email && roomName) {
      const response = yield fetch(
        `${CHAT_SERVER_URL}/api/jisti/invite-by-phone-email`,
        {
          ...
          body: JSON.stringify({
            meeting_id: roomName,
            [selectedOption === "phone" ? "phone_no" : "email"]: selectedOption === "phone" ? String(selectedValue.value) + String(mobile) : email
          })
        }
      );
      if (!response.ok) {
  ...
  const renderInputField = () => {
    if (selectedOption === "phone") {
      return /* @__PURE__ */ React117.createElement(React117.Fragment, null, /* @__PURE__ */ React117.createElement("div", { style: { minWidth: "100px", maxWidth: "150px" } }, /* @__PURE__ */ React117.createElement(
        ...
        "input",
        {
          className: "lk-form-control lk-chat-form-input",
          value: mobile,
          onChange: (e2) => setMobile(e2.target.value),
          type: "text",
  ...
  return /* @__PURE__ */ React117.createElement(
    ...
    showToast ? /* @__PURE__ */ React117.createElement(Toast, { className: "lk-toast-connection-state" }, showToast) : /* @__PURE__ */ React117.createElement(React117.Fragment, null),
    /* @__PURE__ */ React117.createElement("div", { style: { height: "-webkit-fill-available" } }, /* @__PURE__ */ React117.createElement("div", { style: { position: "relative" } }, /* @__PURE__ */ React117.createElement("div", { style: { position: "sticky", top: 0, zIndex: 1 } }, /* @__PURE__ */ React117.createElement(
      "div",
      {
      ...
      !invitedOnCall && /* @__PURE__ */ React117.createElement(
        "button",
        {
          type: "button",
          className: "lk-button lk-chat-form-button",
    ...
    ), activeTab != "invite" && /* @__PURE__ */ React117.createElement(
      "form",
      {
    ...
    ), activeTab === "invite" && /* @__PURE__ */ React117.createElement(React117.Fragment, null, /* @__PURE__ */ React117.createElement("form", null, /* @__PURE__ */ React117.createElement("div", { className: "lk-chat-form" }, "Invitation type:", /* @__PURE__ */ React117.createElement("div", null, /* @__PURE__ */ React117.createElement(
      "input",
      {
        type: "radio",
        id: "phone",
      ...
      "Phone"
    )), /* @__PURE__ */ React117.createElement("div", null, /* @__PURE__ */ React117.createElement(
      "input",
      {
        type: "radio",
        id: "email",
      ...
      "Email"
    ))), /* @__PURE__ */ React117.createElement("div", { className: "lk-chat-form", style: { display: "flex", alignItems: "center" } }, renderInputField(), /* @__PURE__ */ React117.createElement(
      "button",
      {
      ...
      "Invite"
    )))))), activeTab == "contacts" && /* @__PURE__ */ React117.createElement("ul", { style: { height: "77vh", overflow: "scroll", display: "block" }, className: "lk-list lk-chat-messages", ref: ulRef }, filteredContacts.map((user, index) => {
      return /* @__PURE__ */ React117.createElement("li", { key: index, className: "lk-chat-entry" }, /* @__PURE__ */ React117.createElement("div", { style: { width: "100%" } }, /* @__PURE__ */ React117.createElement("span", { className: "lk-message-body text-ellipsis" }, user.full_name), /* @__PURE__ */ React117.createElement("span", { className: "lk-message-body lk-message-text text-ellipsis" }, user.designation ? user.designation : user.user_name ? user.user_name : "-")), /* @__PURE__ */ React117.createElement(
        "button",
        {
    ...
    })), activeTab == "callParticipants" && /* @__PURE__ */ React117.createElement("ul", { style: { height: "77vh", overflow: "scroll", display: "block" }, className: "lk-list lk-chat-messages", ref: ulRef2 }, filteredParticipants.map((user, index) => {
      return /* @__PURE__ */ React117.createElement("li", { key: index, className: "lk-chat-entry" }, /* @__PURE__ */ React117.createElement("div", { style: { width: "100%", display: "flex", flexDirection: "column" } }, /* @__PURE__ */ React117.createElement("span", { className: "lk-message-body text-ellipsis" }, user.full_name, " ", room.localParticipant.identity == user.user_id ? " (me)" : ""), /* @__PURE__ */ React117.createElement("span", { className: "lk-message-body lk-message-text text-ellipsis" }, user.designation ? user.designation : user.user_name ? user.user_name : "-")));
    })))
  );
}
...
function VideoConference(_a2) {
  ...
  const { localParticipant } = useLocalParticipant();
  const p2 = useEnsureParticipant(localParticipant);
  const { infoObserver } = React118.useMemo(() => {
    return (0, import_components_core48.setupParticipantName)(p2);
  }, [p2]);
  const { metadata } = useObservableState(infoObserver, {
    name: p2.name,
    identity: p2.identity,
  ...
  const [showShareButton, setShowShareButton] = React118.useState(showShareLink);
  const [showParticipantButton, setShowParticipantButton] = React118.useState(showParticipant);
  const [leaveButton, setLeaveButton] = React118.useState("Leave");
  const [endForAll, setEndForAll] = React118.useState(false);
  const meta = metadata ? JSON.parse(metadata) : {};
  ...
  const widgetUpdate = (state) => {
    import_components_core48.log.debug("updating widget state", state);
    setWidgetState(state);
    console.log(widgetState);
  };
  const updateCount = (count) => {
    import_components_core48.log.debug("count ", count);
    setWaitingRoomCount(count);
  };
  const layoutContext = useCreateLayoutContext();
  const screenShareTracks = tracks.filter(import_components_core48.isTrackReference).filter((track) => track.publication.source === import_livekit_client19.Track.Source.ScreenShare);
  const whitePub = new import_livekit_client19.TrackPublication(import_livekit_client19.Track.Kind.Unknown, "whiteboard", "whiteboard");
  const whiteboardTrack = {
    participant: p2,
    publication: whitePub,
    source: import_livekit_client19.Track.Source.Unknown
  };
  const focusTrack = (_a3 = usePinnedTracks(layoutContext)) == null ? void 0 : _a3[0];
  const carouselTracks = tracks.filter((track) => !(0, import_components_core48.isEqualTrackRef)(track, focusTrack));
  React118.useEffect(() => {
    if (meta && meta.host) {
  ...
  React118.useEffect(() => {
    ...
    if (screenShareTracks.some((track) => track.publication.isSubscribed) && lastAutoFocusedScreenShareTrack.current === null) {
      import_components_core48.log.debug("Auto set screen share focus:", { newScreenShareTrack: screenShareTracks[0] });
      ...
      import_components_core48.log.debug("Auto clearing screen share focus.");
  ...
  const [isWhiteboard, setIsWhiteboard] = React118.useState(false);
  room.on(import_livekit_client19.RoomEvent.DataReceived, (payload) => {
  ...
  useWarnAboutMissingStyles();
  const [invitedUsers, setInvitedUsers] = React118.useState([]);
  React118.useEffect(() => {
    if (socket) {
      socket.on("meeting:update", (meetingData) => {
        setInvitedUsers(
  ...
  return /* @__PURE__ */ React118.createElement("div", __spreadValues({ className: "lk-video-conference" }, props), (0, import_components_core48.isWeb)() && /* @__PURE__ */ React118.createElement(
    ...
    /* @__PURE__ */ React118.createElement("div", { className: "lk-video-conference-inner" }, !focusTrack ? /* @__PURE__ */ React118.createElement("div", { className: "lk-grid-layout-wrapper" }, /* @__PURE__ */ React118.createElement(GridLayout, { tracks }, /* @__PURE__ */ React118.createElement(ParticipantTile, null))) : /* @__PURE__ */ React118.createElement("div", { className: "lk-focus-layout-wrapper" }, /* @__PURE__ */ React118.createElement(FocusLayoutContainer, null, /* @__PURE__ */ React118.createElement(CarouselLayout, { tracks: carouselTracks }, /* @__PURE__ */ React118.createElement(ParticipantTile, null)), focusTrack && /* @__PURE__ */ React118.createElement(FocusLayout, { trackRef: focusTrack }))), /* @__PURE__ */ React118.createElement(
      ControlBar,
      {
        controls: {
          chat: showChatButton,
    ...
    showShareButton && isCallScreen ? /* @__PURE__ */ React118.createElement(
      CallUser,
      {
        style: {
    ...
    ) : /* @__PURE__ */ React118.createElement(React118.Fragment, null),
    showShareButton && !isCallScreen ? /* @__PURE__ */ React118.createElement(
      ShareLink,
      {
        style: {
    ...
    showParticipantButton ? /* @__PURE__ */ React118.createElement(
      Users,
      {
    ...
    showChatButton ? /* @__PURE__ */ React118.createElement(
      Chat,
      {
...
function AudioConference(_a2) {
  ...
  const audioTracks = useTracks([import_livekit_client20.Track.Source.Microphone]);
  useWarnAboutMissingStyles();
  ...
  ), widgetState.showChat == "show_chat" && /* @__PURE__ */ React119.createElement(Chat, null)));
}
