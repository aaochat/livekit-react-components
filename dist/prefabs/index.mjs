...
function useToggleUserLink({ props }) {
  const { dispatch, state } = useLayoutContext().widget;
  const { className } = React87.useMemo(() => setupUserToggle(), []);
...
var ToggleSwitch = ({
  ...
  return /* @__PURE__ */ React92.createElement("div", { className: "toggle-switch" + (small ? " small-switch" : "") }, /* @__PURE__ */ React92.createElement(
    "input",
    {
      type: "checkbox",
      name,
  ...
  ), id ? /* @__PURE__ */ React92.createElement(
    "label",
    {
...
function VideoConference(_a) {
  ...
  return /* @__PURE__ */ React96.createElement("div", __spreadValues({ className: "lk-video-conference" }, props), isWeb() && /* @__PURE__ */ React96.createElement(
