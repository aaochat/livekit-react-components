...
function useChatToggle({ props }) {
  ...
  const { className } = React31.useMemo(() => setupChatToggle(), []);
...
function LayoutContextProvider({
  ...
  React58.useEffect(() => {
    log8.debug("Chat Widget Updated", { widgetState: layoutContextValue.widget.state });
...
import { getTrackReferenceId as getTrackReferenceId3, isLocal as isLocal2 } from "@livekit/components-core";
...
function RoomAudioRenderer() {
  ...
  return /* @__PURE__ */ React60.createElement("div", { style: { display: "none" } }, tracks.map((trackRef) => /* @__PURE__ */ React60.createElement(AudioTrack, { key: getTrackReferenceId3(trackRef), trackRef })));
}
...
function useToggleShareLink({ props }) {
  const { dispatch, state } = useLayoutContext().widget;
  const { className } = React62.useMemo(() => setupShareLinkToggle(), []);
...
function useIsEncrypted(participant) {
  ...
  const observer = React70.useMemo(() => encryptionStatusObservable(room, p), [room, p]);
...
function ParticipantTile(_a) {
  ...
  return /* @__PURE__ */ React71.createElement("div", __spreadValues({ style: { position: "relative" } }, elementProps), /* @__PURE__ */ React71.createElement(TrackRefContextIfNeeded, { trackRef: trackReference }, /* @__PURE__ */ React71.createElement(ParticipantContextIfNeeded, { participant: trackReference.participant }, children != null ? children : /* @__PURE__ */ React71.createElement(React71.Fragment, null, isTrackReference3(trackReference) && (((_a2 = trackReference.publication) == null ? void 0 : _a2.kind) === "video" || trackReference.source === Track6.Source.Camera || trackReference.source === Track6.Source.ScreenShare) ? /* @__PURE__ */ React71.createElement(
    VideoTrack,
    {
  ...
  ) : isTrackReference3(trackReference) && /* @__PURE__ */ React71.createElement(
    AudioTrack,
    {
      trackRef: trackReference,
      onSubscriptionStatusChanged: handleSubscribe
    }
  ), /* @__PURE__ */ React71.createElement("div", { className: "lk-participant-placeholder" }, /* @__PURE__ */ React71.createElement(ParticipantPlaceholder_default, null)), /* @__PURE__ */ React71.createElement("div", { className: "lk-participant-metadata" }, /* @__PURE__ */ React71.createElement("div", { className: "lk-participant-metadata-item" }, trackReference.source === Track6.Source.Camera ? /* @__PURE__ */ React71.createElement(React71.Fragment, null, isEncrypted && /* @__PURE__ */ React71.createElement(LockLockedIcon_default, { style: { marginRight: "0.25rem" } }), /* @__PURE__ */ React71.createElement(
    TrackMutedIndicator,
    {
...
function AudioVisualizer(_a) {
  ...
  if (!ref) {
    ...
    ref = { participant: p, source: Track7.Source.Microphone };
  }
...
function ParticipantAudioTile(_a) {
  ...
  return /* @__PURE__ */ React81.createElement("div", __spreadValues({ style: { position: "relative" } }, elementProps), /* @__PURE__ */ React81.createElement(ParticipantContextIfNeeded, { participant: p }, children != null ? children : /* @__PURE__ */ React81.createElement(React81.Fragment, null, /* @__PURE__ */ React81.createElement(AudioTrack, { source: source != null ? source : Track8.Source.Microphone }), /* @__PURE__ */ React81.createElement(AudioVisualizer, null), /* @__PURE__ */ React81.createElement("div", { className: "lk-participant-metadata" }, /* @__PURE__ */ React81.createElement("div", { className: "lk-participant-metadata-item" }, /* @__PURE__ */ React81.createElement(TrackMutedIndicator, { source: Track8.Source.Microphone }), /* @__PURE__ */ React81.createElement(ParticipantName, null)), /* @__PURE__ */ React81.createElement(ConnectionQualityIndicator, { className: "lk-participant-metadata-item" })))));
}
...
function useToggleUserLink({ props }) {
  const { dispatch, state } = useLayoutContext().widget;
  const { className } = React84.useMemo(() => setupUserToggle(), []);
...
var ToggleSwitch = ({
  ...
  return /* @__PURE__ */ React89.createElement("div", { className: "toggle-switch" + (small ? " small-switch" : "") }, /* @__PURE__ */ React89.createElement(
    "input",
    {
      type: "checkbox",
      name,
  ...
  ), id ? /* @__PURE__ */ React89.createElement(
    "label",
    {
...
// src/prefabs/VideoConference.tsx
import { isEqualTrackRef, isTrackReference as isTrackReference4, log as log10, isWeb, setupParticipantName as setupParticipantName3 } from "@livekit/components-core";
...
function VideoConference(_a) {
  ...
  return /* @__PURE__ */ React93.createElement("div", __spreadValues({ className: "lk-video-conference" }, props), isWeb() && /* @__PURE__ */ React93.createElement(
