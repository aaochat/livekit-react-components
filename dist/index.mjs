...
function PreJoin(_a) {
  ...
  const [username, setUsername] = React120.useState((_a2 = defaults.username) != null ? _a2 : initialUserChoices.username);
  React120.useEffect(() => {
...
function InviteViaPhone(_a) {
  ...
  )), /* @__PURE__ */ React121.createElement("input", { className: "lk-form-control lk-chat-form-input", type: "tel", onChange: (e) => setMobile(e.target.value), placeholder: "Enter Mobile Number", pattern: "[0-9]+", title: "Enter valid mobile number", maxLength: 10, minLength: 10, value: mobile }), /* @__PURE__ */ React121.createElement("button", { type: "submit", className: "lk-button lk-chat-form-button tl-invite-button" }, "Invite")));
}
...
function useToast() {
  const [showToast, setShowToast] = React123.useState(false);
  React123.useEffect(() => {
    if (showToast) {
      setTimeout(() => {
        setShowToast(false);
...
function useToggleUserLink({ props }) {
  const { dispatch, state } = useLayoutContext().widget;
  const { className } = React126.useMemo(() => setupUserToggle(), []);
...
function BlurIndicater({ source, parentCallback }) {
  ...
  const room = useRoomContext();
  const [isBlur, setIsBlur] = React127.useState(false);
  const [isCameraEnabled, setIsCameraEnabled] = React127.useState(false);
  ...
  return /* @__PURE__ */ React127.createElement("button", { className: "tl-blur lk-button", onClick: toggleBlur, disabled: isCameraEnabled }, isBlur ? "Remove Blur" : "Blur Background");
}
...
function WhiteboardIndicater({
  ...
  const [disableWhiteboard, setDisableWhiteboard] = React128.useState(false);
  const [title, setTitle] = React128.useState("Whiteboard");
  React128.useEffect(() => {
  ...
  return /* @__PURE__ */ React128.createElement("button", { disabled: disableWhiteboard, className: "tl-blur lk-button", onClick: toggleWhiteboard }, title);
}
...
var StartMediaButton = /* @__PURE__ */ React130.forwardRef(function StartMediaButton2(_a, ref) {
...
import React133, { useEffect as useEffect35, useState as useState30, useRef as useRef14 } from "react";
function RecordingControls({ onRecordingChange }) {
  ...
  return /* @__PURE__ */ React133.createElement("div", { className: "relative" }, isOpen && /* @__PURE__ */ React133.createElement("div", { ref: menuRef, style: { position: "absolute", bottom: "60px" } }, /* @__PURE__ */ React133.createElement("ul", { className: "lk-recording-menu" }, /* @__PURE__ */ React133.createElement("li", null, /* @__PURE__ */ React133.createElement(
    "button",
    {
      onClick: () => {
    ...
    "Image Recording"
  )), /* @__PURE__ */ React133.createElement("li", null, /* @__PURE__ */ React133.createElement(
    "button",
    {
      onClick: () => {
    ...
    isLoading ? "Processing..." : /* @__PURE__ */ React133.createElement(React133.Fragment, null, /* @__PURE__ */ React133.createElement(RecordingIcon_default, { color: isRecording ? "red" : "green" }), isRecording ? "Stop Recording" : "Start Recording"),
    /* @__PURE__ */ React133.createElement(Chevron_default, { className: "lk-recording-arrow" })
  ));
}

// src/prefabs/RecordingIndicator.tsx
import React134, { useEffect as useEffect36, useState as useState31 } from "react";
function RecordingIndicator({ recordingStartTime }) {
  ...
  return /* @__PURE__ */ React134.createElement("div", { className: "lk-recording" }, /* @__PURE__ */ React134.createElement("span", null, /* @__PURE__ */ React134.createElement(RecordingIcon_default, { color: "red" })), /* @__PURE__ */ React134.createElement("span", null, formatTime(elapsedSeconds)));
}
...
function ControlBar(_a) {
  ...
  ))), visibleControls.camera && /* @__PURE__ */ React135.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React135.createElement(TrackToggle, { source: Track10.Source.Camera, showIcon, onChange: cameraOnChange }, showText && "Camera"), /* @__PURE__ */ React135.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React135.createElement(
    MediaDeviceMenu,
    {
      kind: "videoinput",
...
var ToggleSwitch = ({
  ...
  return /* @__PURE__ */ React137.createElement("div", { className: "toggle-switch" + (small ? " small-switch" : "") }, /* @__PURE__ */ React137.createElement(
    "input",
    {
      type: "checkbox",
      name,
  ...
  ), id ? /* @__PURE__ */ React137.createElement(
    "label",
    {
