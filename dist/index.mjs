...
function ShareLink(_a) {
  ...
  return /* @__PURE__ */ React109.createElement("div", __spreadProps(__spreadValues({}, props), { className: "lk-chat lk-sharelink" }), /* @__PURE__ */ React109.createElement("form", { className: "lk-chat-form" }, /* @__PURE__ */ React109.createElement("input", { className: "lk-form-control lk-chat-form-input", type: "text", value: link, readOnly: true }), /* @__PURE__ */ React109.createElement("button", { type: "button", className: "lk-button lk-chat-form-button", onClick: handleCopy }, "Copy")), showToast ? /* @__PURE__ */ React109.createElement(Toast, { className: "lk-toast-connection-state" }, "Copied") : /* @__PURE__ */ React109.createElement(React109.Fragment, null), showInviteUser ? /* @__PURE__ */ React109.createElement("form", { className: "lk-chat-form", onSubmit: handleSubmit }, /* @__PURE__ */ React109.createElement(
    ...
    return /* @__PURE__ */ React109.createElement("li", { key: index, className: "lk-chat-entry" }, /* @__PURE__ */ React109.createElement("div", null, /* @__PURE__ */ React109.createElement("span", { className: "lk-message-body" }, user.full_name)), /* @__PURE__ */ React109.createElement("button", { type: "button", onClick: () => handleInvite(user), className: "lk-button lk-chat-form-button" + (user.invited ? " invited" : "") }, user.invited ? "Invited" : "Invite"));
  })) : "");
}
