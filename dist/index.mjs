...
function useToggleUserLink({ props }) {
  const { dispatch, state } = useLayoutContext().widget;
  const { className } = React101.useMemo(() => setupUserToggle(), []);
...
function ControlBar(_a) {
  ...
  return /* @__PURE__ */ React104.createElement("div", __spreadValues({}, htmlProps), visibleControls.microphone && /* @__PURE__ */ React104.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React104.createElement(TrackToggle, { source: Track9.Source.Microphone, showIcon }, showText && "Microphone"), /* @__PURE__ */ React104.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React104.createElement(MediaDeviceMenu, { kind: "audioinput" }))), visibleControls.camera && /* @__PURE__ */ React104.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React104.createElement(TrackToggle, { source: Track9.Source.Camera, showIcon }, showText && "Camera"), /* @__PURE__ */ React104.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React104.createElement(MediaDeviceMenu, { kind: "videoinput" }))), visibleControls.screenShare && browserSupportsScreenSharing && /* @__PURE__ */ React104.createElement(
    TrackToggle,
    {
...
var ToggleSwitch = ({
  ...
  return /* @__PURE__ */ React106.createElement("div", { className: "toggle-switch" + (small ? " small-switch" : "") }, /* @__PURE__ */ React106.createElement(
    "input",
    {
      type: "checkbox",
      name,
  ...
  ), id ? /* @__PURE__ */ React106.createElement(
    "label",
    {
...
function ShareLink(_a) {
  ...
  const [users, setUsers] = React109.useState([]);
  const [searched, setSearched] = React109.useState([]);
  const [showToast, setShowToast] = React109.useState(false);
  ...
  const { infoObserver } = React109.useMemo(() => {
  ...
  return /* @__PURE__ */ React109.createElement("div", __spreadProps(__spreadValues({}, props), { className: "lk-chat lk-sharelink" }), /* @__PURE__ */ React109.createElement("form", { className: "lk-chat-form" }, /* @__PURE__ */ React109.createElement("input", { className: "lk-form-control lk-chat-form-input", type: "text", value: link, readOnly: true }), /* @__PURE__ */ React109.createElement("button", { type: "button", className: "lk-button lk-chat-form-button", onClick: handleCopy }, "Copy")), showToast ? /* @__PURE__ */ React109.createElement(Toast, { className: "lk-toast-connection-state" }, "Copied") : /* @__PURE__ */ React109.createElement(React109.Fragment, null), showInviteUser ? /* @__PURE__ */ React109.createElement("form", { className: "lk-chat-form", onSubmit: handleSubmit }, /* @__PURE__ */ React109.createElement(
    "input",
    {
      className: "lk-form-control lk-chat-form-input",
      ref: inputRef,
  ...
  )) : /* @__PURE__ */ React109.createElement(React109.Fragment, null), showInviteUser && searched.length > 0 ? /* @__PURE__ */ React109.createElement("ul", { className: "lk-list lk-chat-messages", ref: ulRef }, searched.map((user, index) => {
    return /* @__PURE__ */ React109.createElement("li", { key: index, className: "lk-chat-entry" }, /* @__PURE__ */ React109.createElement("div", null, /* @__PURE__ */ React109.createElement("span", { className: "lk-message-body" }, user.full_name), /* @__PURE__ */ React109.createElement("span", { className: "lk-message-body lk-message-text" }, user.user_name)), /* @__PURE__ */ React109.createElement("button", { type: "button", onClick: () => handleInvite(user), className: "lk-button lk-chat-form-button" + (user.invited ? " invited" : "") }, user.invited ? "Invited" : "Invite"));
  })) : "");
}
